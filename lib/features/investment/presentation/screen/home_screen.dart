...
import 'package:my_new_flutter_app/features/investment/presentation/screen/new_invesment_screen.dart';
import 'package:my_new_flutter_app/features/investment/presentation/viewmodel/investment_viewmodel.dart';
import 'package:my_new_flutter_app/features/login/presentation/login_screen.dart';
import 'package:my_new_flutter_app/features/core/presentation/wigets/styled_button.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final ref = this.ref;
    final investmentProvider = ref.watch(investmentViewModelProvider);
    return Scaffold(
      appBar: AppBar(
